...
public class EntityDuplicatedException extends RuntimeException {
     ...
     */
    public EntityDuplicatedException(int code, String codeName) {
        this.code = code;
     ...
     */
    public EntityDuplicatedException(int code, String codeName, String errorMessage) {
        this.code = code;
        this.codeName = codeName;
     ...
     */
    public EntityDuplicatedException(int code, String codeName, HttpStatus httpStatus) {
        this.code = code;
        this.codeName = codeName;
